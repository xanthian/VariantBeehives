...
public class Vinery {
    ...
    public static Map<Identifier, Block> LDV_HIVES = Maps.newHashMap();

    public static Block LDV_CHERRY_BEEHIVE;

    public static void registerHives() {
        LDV_CHERRY_BEEHIVE = registerBeehives("ldv_cherry_beehive");
    }

    private static Block register(String name, Block block) {
        Identifier identifier = new Identifier(Initialise.MOD_ID, name);
        Registry.register(Registries.BLOCK, identifier, block);
        LDV_HIVES.put(identifier, block);
