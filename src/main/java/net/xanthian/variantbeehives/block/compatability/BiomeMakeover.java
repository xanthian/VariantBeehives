...
public class BiomeMakeover {
    ...
    public static Map<Identifier, Block> BM_HIVES = Maps.newHashMap();

    public static Block BM_ANCIENT_OAK_BEEHIVE;
    public static Block BM_BLIGHTED_BALSA_BEEHIVE;
    public static Block BM_SWAMP_CYPRESS_BEEHIVE;
    public static Block BM_WILLOW_BEEHIVE;
