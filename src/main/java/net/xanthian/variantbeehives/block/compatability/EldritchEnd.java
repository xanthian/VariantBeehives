...
public class EldritchEnd {
    ...
    public static Map<Identifier, Block> EE_HIVES = Maps.newHashMap();

    public static Block EE_PRIMORDIAL_BEEHIVE;

    public static void registerHives() {
        EE_PRIMORDIAL_BEEHIVE = registerBeehives("ee_primordial_beehive");
    }

    private static Block register(String name, Block block) {
        Identifier identifier = new Identifier(Initialise.MOD_ID, name);
        Registry.register(Registries.BLOCK, identifier, block);
        EE_HIVES.put(identifier, block);
