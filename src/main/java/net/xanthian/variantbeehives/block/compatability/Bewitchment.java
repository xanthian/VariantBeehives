...
public class Bewitchment {
    ...
    public static Map<Identifier, Block> BW_HIVES = Maps.newHashMap();

    public static Block BW_CYPRESS_BEEHIVE;
    public static Block BW_DRAGONS_BLOOD_BEEHIVE;
    public static Block BW_ELDER_BEEHIVE;
    public static Block BW_JUNIPER_BEEHIVE;
