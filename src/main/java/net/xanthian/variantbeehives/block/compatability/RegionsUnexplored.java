...
public class RegionsUnexplored {
    ...
    public static Block RU_CHERRY_BEEHIVE;
    public static Block RU_SCULKWOOD_BEEHIVE;
    ...
    public static void registerHives() {
        ...
        RU_CHERRY_BEEHIVE = registerBeehives("ru_cherry_beehive");
        RU_SCULKWOOD_BEEHIVE = registerBeehives("ru_sculkwood_beehive");
