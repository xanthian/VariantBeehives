...
public class DeeperAndDarker {
    ...
    public static Map<Identifier, Block> DAD_HIVES = Maps.newHashMap();

    public static Block DAD_ECHO_BEEHIVE;

    public static void registerHives() {
        DAD_ECHO_BEEHIVE = registerBeehives("dad_echo_beehive");
    }

    private static Block register(String name, Block block) {
        Identifier identifier = new Identifier(Initialise.MOD_ID, name);
        Registry.register(Registries.BLOCK, identifier, block);
        DAD_HIVES.put(identifier, block);
